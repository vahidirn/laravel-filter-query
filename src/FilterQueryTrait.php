...
trait FilterQueryTrait
{
    ...
    {
        if ($arg === null) {
            throw new FilterQueryException('LIKE rule does not accept null"');
        }
    ...
    {
        if ($arg === null) {
            throw new FilterQueryException('ILIKE rule does not accept null"');
        }
    ...
    {
        if ($arg === null) {
            throw new FilterQueryException('MATCH rule does not accept null"');
        }
